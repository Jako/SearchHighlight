...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            if ($oldPackage && $oldPackage->compareVersion('2.2.0', '>')) {
                $cleanup = [
                    'core' => [
                        'components/searchhighlight/model/searchhighlight/events'
                    ]
                ];
                cleanupFolders($modx, $corePath, $assetsPath, $cleanup, 'SearchHighlight', '2.2.0');
            }
            $success = true;
            break;
